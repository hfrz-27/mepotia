...
/** Ana sayfa koleksiyon slotları — admin seçimi */
export const HOME_COLLECTIONS = {
  featured: {
    ...
    description: "Senin seçtiğin fırsat ürünleri — özenle işaretlenmiş.",
  },
  curated: {
    key: "curated",
    ...
    description: "El ile seçtiğin vitrin ilanları.",
  },
  popular: {
    key: "popular",
    ...
    description: "Senin öne çıkardığın popüler seçki.",
  },
};
...
export async function getPublishedProducts({
  ...
  const build = (select) => {
    ...
    if (homeCollection) {
      ...
      // Geriye dönük: is_featured veya home_collection=featured
      query = query.or("is_featured.eq.true,home_collection.eq.featured");
    }
