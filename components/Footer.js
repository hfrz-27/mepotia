  ...
  return (
    <footer className="mt-auto bg-[#09090c] text-white">
            ...
            <div className="sm:col-span-2 lg:col-span-1">
              ...
              <div className="mt-5 flex flex-wrap gap-2">
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="inline-flex h-10 items-center gap-1.5 rounded-full bg-[#0071e3] px-4 text-[12px] font-semibold text-white transition hover:bg-[#0077ed]"
                >
      ...
      <div className="border-t border-white/10 bg-[#09090c]">
        <div className="mx-auto flex max-w-[1200px] flex-col gap-2 px-4 py-4 text-[10px] text-white/32 sm:flex-row sm:items-center sm:justify-between sm:px-6">
