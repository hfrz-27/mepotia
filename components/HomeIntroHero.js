...
/**
 * Intro — arama + 4 kategori (Telefon, Bilgisayar, Tablet, Tümü).
 */
export default function HomeIntroHero() {
  return (
    <section className="bg-[#f5f5f7] pt-5 pb-2 sm:pt-8 sm:pb-3" aria-label="Giriş">
      <div className="pv-wrap">
        ...
        {/* 4 kategori yan yana — pv-wrap hizalı */}
          ...
          {CATS.map((cat) => {
            ...
            return (
              <Link
                key={cat.href}
                href={cat.href}
                className="group flex flex-col items-center gap-1.5 rounded-[14px] bg-white px-1 py-2.5 text-center ring-1 ring-black/[0.05] transition active:scale-[0.98] sm:gap-2 sm:rounded-[16px] sm:py-3"
              >
